...
subprocess.run(["lua", str(root / "tests/companion_attack_admission_test.lua")], cwd=root, check=True)
...
subprocess.run(["lua", str(root / "tests/druid_enrage_test.lua")], cwd=root, check=True)
...
subprocess.run(["lua", str(root / "tests/warrior_overpowering_rage_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/warrior_reprisal_test.lua")], cwd=root, check=True)
...
subprocess.run(["lua", str(root / "tests/warrior_berserker_rage_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/warrior_cost_passives_test.lua")], cwd=root, check=True)
...
subprocess.run(["lua", str(root / "tests/shaman_spirit_armor_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/shaman_weapon_imbues_test.lua")], cwd=root, check=True)
...
subprocess.run(["lua", str(root / "tests/priest_shadow_mend_test.lua")], cwd=root, check=True)
...
subprocess.run(["lua", str(root / "tests/priest_spirit_tap_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/paladin_wisdom_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/paladin_lay_on_hands_guard_test.lua")], cwd=root, check=True)
...
subprocess.run(["lua", str(root / "tests/druid_growl_test.lua")], cwd=root, check=True)
...
subprocess.run(["lua", str(root / "tests/druid_barkskin_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/druid_thorns_test.lua")], cwd=root, check=True)
...
subprocess.run(["lua", str(root / "tests/rogue_blade_flurry_guard_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/rogue_poison_data_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/rogue_poison_state_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/rogue_poison_proc_test.lua")], cwd=root, check=True)
...
subprocess.run(["lua", str(root / "tests/pet_defensive_actions_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/companion_defensives_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/periodic_scoring_test.lua")], cwd=root, check=True)
subprocess.run(["lua", str(root / "tests/periodic_refresh_test.lua")], cwd=root, check=True)
