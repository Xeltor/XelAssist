...
| Paladin | Aura, Seal, Blessing and Judgement lifecycle; exact Blessing/Righteous Fury threat, Might and self Wisdom consequences; Seal of Righteousness/Judgement; Hand of Reckoning; bounded Consecration; observed-only Holy Shock GCD/cooldown modifier auras with branch-local consumption. | Holy Shock and Blessed Strikes proc generation plus post-consumption baseline timing; Seal of the Martyr; Conviction; Crusader Strike vulnerability; later Consecration recipients; remaining Seal/Judgement and multi-recipient blessing effects. |
| Priest | PW:S/Weakened Soul; Shadowform and active Improved Shadowform engine costs; Inner Focus/Power Infusion; healing triage; Fade; hostile Chastise; exact Ascendance action/aura/Apotheosis identity and active-state engine healing costs. | Ascendance future activation, CC purge, private cast/cost arithmetic and Apotheosis fanout; Improved Shadowform casting regen; Chastise ally branch; Spirit Tap; Shadow Mend/Pain Spike; Vampiric fanout and multi-recipient support. |
