...
| Warrior | Stances, Tactical Mastery and Defiance profiles; white-hit/bounded incoming rage; Charge, Bloodrage, Taunt, Sunder, Battle Shout, Revenge, Heroic Strike, Thunder Clap, Execute, Demoralizing Shout, Shield Bash and Shield Wall; legal Shield Block one/two-charge window; exact Charge in Combat and Overpower; Devastate's exact weapon/Sunder-stack damage and landed Sunder refresh. | Shield Block value/facing and counterfactual mitigation; Shield Mastery/Reprisal/Improved Shield Slam; Devastate's and Shield Bash's private supplemental threat; Hamstring/Disarm/Shield Slam packets and Octo threat; Overpowering Rage haste, Whirlwind targets, reduced Heroic Strike/Slam threat and Bloodthirst/Mortal Strike cost passives; Berserker Rage and incoming-rage modifiers. |
