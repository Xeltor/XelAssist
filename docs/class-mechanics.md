...
| Warrior | Stances, Tactical Mastery retention and Defiance/threat/mitigation profiles; white-hit rage runway; Charge, Bloodrage, Taunt, Sunder Armor, Battle Shout, Revenge, Heroic Strike and Thunder Clap damage/threat; grouped Battle Shout's exact self AP plus bounded subgroup/pet and flat-threat fanout; Demoralizing Shout's per-recipient flat threat and aura lifecycle; exact Shield Wall damage-taken composition. | Thunder Clap's slow and Demoralizing Shout's attack-power mitigation until hostile white-swing timing exists; Shield Block until hostile white-swing victim/type/facing, attacker skill and exact shield-block value exist; other defensive consequences; exact Shield Bash/Hamstring/Disarm/Overpower/Shield Slam packets; server threat and Shield Wall profiles remain visibly runtime-unverified where the live server cannot attest them. |
