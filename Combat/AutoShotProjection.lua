...
local function projectedState(snapshot)
    return { supported = snapshot and snapshot.supported,
        ...
        rangeChecked = snapshot and snapshot.rangeChecked,
        rangeVerdict = snapshot and snapshot.rangeVerdict,
        rangeIdentityVerified = snapshot and snapshot.rangeIdentityVerified,
        rangeTargetGuid = snapshot and snapshot.rangeTargetGuid,
        rangeSpellId = snapshot and snapshot.rangeSpellId,
        distance = snapshot and snapshot.distance,
        distanceKind = snapshot and snapshot.distanceKind,
        projectileDistance = snapshot and snapshot.projectileDistance,
        projectileDistanceKind = snapshot and snapshot.projectileDistanceKind,
        ...
        projectileSpeedSource = snapshot and snapshot.projectileSpeedSource,
        ...
        unknownInFlight = snapshot and snapshot.unknownInFlight,
        launchTimingUnknown = snapshot and snapshot.launchTimingUnknown,
        flightOverflowGlobal = snapshot and snapshot.flightOverflowGlobal,
